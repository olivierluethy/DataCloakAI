  ...
  const testimonials = [
    {
      ...
      avatar: "michaeldavis.avif", // replace with chosen Unsplash image
    },

    {
      ...
      avatar: "sarahmitchell.avif", // Professional woman, business attire
    },
    {
      quote:
      ...
      avatar: "davidrosenberg.avif", // Mature man, serious business portrait
    },
    {
      quote:
      ...
      avatar: "lauravandenberg.avif", // Elegant professional woman
    },
    {
      quote:
      ...
      avatar: "coloneljamescarter.avif", // Mature man, short hair, authoritative look
    },
    {
      quote:
      ...
      avatar: "priyasharma.avif", // Indian woman, confident tech portrait
    },
    {
      quote:
      ...
      avatar: "thomasmueller.avif", // Professional man, business portrait
    },
    {
      quote:
      ...
      avatar: "rebeccagoldstein.avif", // Elegant woman in suit
    },
    {
      quote:
      ...
      avatar: "enoracarpentier.avif", // Professional woman, finance/strategy look
    },
  ];
      ...
      <div className="mx-auto max-w-6xl relative z-10 space-y-12 sm:space-y-16 lg:space-y-20">
        ...
        >
          ...
          <p className="text-lg sm:text-xl lg:text-2xl text-muted-foreground leading-relaxed font-light">
            Hundreds of professionals across regulated industries — consulting,
            fintech, healthcare, and defense — have already{" "}
            <span className="text-white italic font-semibold">
              paid for early access
            </span>{" "}
            because they are currently{" "}
            <span className="font-semibold text-foreground">
              blocked from using AI
            </span>{" "}
            due to data privacy risks.
          </p>
          <p className="text-base sm:text-lg lg:text-xl text-muted-foreground">
            These leaders know exactly how much productivity they're leaving on
            the table — and they're ready the moment a truly private solution
            arrives.
          </p>
          <p className="text-xl sm:text-2xl lg:text-3xl font-semibold text-foreground">
            Join{" "}
            <span className="text-white italic">500+ early access users</span> —
            teams currently blocked from AI due to privacy risks.
          </p>
        </motion.div>
